...
function App() {
  return (
    <main className='relative flex flex-col justify-start h-screen overflow-x-hidden mob-medium:overflow-hidden desk-small:w-full desk-small:py-8 desk-small:gap-6 mob-small:bg-[url("./assets/Mask.png")] bg-cover bg-center'>
      <img
        src={graph}
